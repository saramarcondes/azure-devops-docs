...
> [!div class="mx-imgBorder"] > ![Modernized column options](media/125_01.png)
...
> [!div class="mx-imgBorder"] > ![Not In query operator](media/125_02.png)
...
> [!div class="mx-imgBorder"] > ![Filtering on Plans](media/125_03.png)
...
> [!div class="mx-imgBorder"] > ![Mention a pull request](media/125_05.png)
...
> [!div class="mx-imgBorder"] > ![Toggle in diff views](media/125_10.png)
...
> [!div class="mx-imgBorder"] > ![Package UX unified filter bar](media/125_06.png)
...
> [!div class="mx-imgBorder"] > ![Updated create release experience](media/125_07c.png)
...
> [!div class="mx-imgBorder"] > ![Inline GitHub connection](media/125_08.png)
...
> [!div class="mx-imgBorder"] > ![Azure Resource Group task exposes deployment outputs](media/125_09.png)
...
> [!div class="mx-imgBorder"] > ![Circle avatars](media/125_12.png)
...
> [!div class="mx-imgBorder"] > ![Project tags](media/125_11.png)
