...
> [!div class="mx-imgBorder"] > ![Work Items sorting options](media/131_02.png)
...
> [!div class="mx-imgBorder"] > ![Team parameter](media/131_13.png)
...
> [!div class="mx-imgBorder"] > ![DevOps Project VM option](media/131_09.png)
...
> [!div class="mx-imgBorder"] > ![Partially download artifacts](media/131_07.png)
...
> [!div class="mx-imgBorder"] > ![Tasks for Gradle and Maven](media/131_03.png)
...
> [!div class="mx-imgBorder"] > ![Tag sources options](media/131_04.png)

Then watch build tags appear on your GitHub or GitHub Enterprise repository.

> [!div class="mx-imgBorder"] > ![Tagged sources examples in GitHub](media/131_05.png)
...
> [!div class="mx-imgBorder"] > ![Azure subscription Authorize advanced options](media/131_10.png)
...
> [!div class="mx-imgBorder"] > ![Security dialog](media/131_11.png)
...
> [!div class="mx-imgBorder"] > ![Badge options](media/131_06.png)
...
> [!div class="mx-imgBorder"] > ![Badge on readme](media/131_12.png)
...
> [!div class="mx-imgBorder"] > ![Add alternate account to subscriptions](media/131_08.png)
