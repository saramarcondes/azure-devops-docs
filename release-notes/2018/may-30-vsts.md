...
> [!div class="mx-imgBorder"] > ![Column Options in the Work Items hub](media/135_01.png)
...
> [!div class="mx-imgBorder"] > ![Bypass policy notification](media/135_11.png)
...
> [!div class="mx-imgBorder"] > ![Release Pipeline view](media/135_03.png)
...
> [!div class="mx-imgBorder"] > ![Release artifacts and environments](media/135_04.png)
...
> [!div class="mx-imgBorder"] > ![Release environment actions](media/135_05.png)

Graphical views of the gates and a quick action to view logs helps to keep releases moving.

> [!div class="mx-imgBorder"] > ![Release environment actions](media/135_05b.png)
...
> [!div class="mx-imgBorder"] > ![Release environment commits and work items](media/135_06.png)
...
> [!div class="mx-imgBorder"] > ![Release environment logs](media/135_07.png)

Plus you can click into the logs to enter a focused view, which also will be coming to build and test views soon.

> [!div class="mx-imgBorder"] > ![Release environment logs detail](media/135_07b.png)
...
> [!div class="mx-imgBorder"] > ![Release test results](media/135_08.png)
...
> [!div class="mx-imgBorder"] > ![Add Azure Resource Manager Service Endpoint dialog](media/135_09.png)
...
> [!div class="mx-imgBorder"] > ![VSTS PAT added email](media/135_02.png)
