...
> [!div class="mx-imgBorder"] > ![Use Ruby task](media/134_01.png)
...
> [!div class="mx-imgBorder"] > ![Use Python task](media/134_02.png)
...
> [!div class="mx-imgBorder"] > ![Python Package task](media/134_03.png)
...
> [!div class="mx-imgBorder"] > ![Set Java version](media/134_04.png)
...
> [!div class="mx-imgBorder"] > ![Release gates panel](media/134_09.png)
...
> [!div class="mx-imgBorder"] > ![Select an Azure Service to deploy the application](media/134_11.png)
...
> [!div class="mx-imgBorder"] > ![Add a database](media/134_10.png)
...
> [!div class="mx-imgBorder"] > ![Connect to Azure](media/134_08.png)
...
> [!div class="mx-imgBorder"] > ![Test Plans landing page](media/134_07.png)
...
> [!div class="mx-imgBorder"] > ![Move page dialog](media/134_05.png)

You’ll then be shown a list of the **Page links** and **Work items** affected before you take action.

> [!div class="mx-imgBorder"] > ![Move page links](media/134_06.png)
