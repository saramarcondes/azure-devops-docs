...
> [!div class="nextstepaction"][configure your cumulative flow charts](cumulative-flow.md) or
...
> [!div class="nextstepaction"][configure your cumulative flow chart](cumulative-flow.md)
> ::: moniker-end
