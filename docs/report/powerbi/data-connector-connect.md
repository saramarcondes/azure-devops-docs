...
**A:** You can encounter this error if you have access to a given project but you do not have the _View analytics_ permissions. Please work with your project administrator to get these permissions.
