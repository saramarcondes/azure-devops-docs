...
The Wiki Git repo is referred as _TeamProjectName.wiki_. For example, if your team project is 'foobar' then the Wiki repo is labeled 'foobar.wiki'.
...
The _TeamProjectName.wiki_ doesn't appear in the drop-down menu of repositories from **Repos** or **Code**. It also isn't in the list provided from the **Project Settings > Repositories** or **Project Settings > Version Control** pages.  
...
> [!div class="nextstepaction"][add and edit wiki pages](add-edit-wiki.md)
