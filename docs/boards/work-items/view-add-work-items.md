...
> [!div class="mx-imgBorder"] > ![Boards>Work Items, Filter to show Bugs ](media/view-add/work-items-filter-bug.png)

#### [Visual Studio 2019](#tab/visual-studio/)

> [!div class="mx-imgBorder"] > ![Team Explorer>Work Items, Filter based on a key word ](media/view-add/filter-list-vs-te.png)
...
> [!div class="mx-imgBorder"] > ![Boards>Work Items, Following view, Select work items, context menu](media/view-add/following-context-menu.png)
